...
import oracleOsImage from '../../../assets/images/projects/oracleos.png'
import torstendnghImage from '../../../assets/images/projects/torstendngh.png'
    ...
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <div className={styles.grid} >
          ...
          <ProjectTile title={"torstendngh.com"} tags={["React", "JavaScript", "Vite"]} description={"The website you are looking at right now"} isOnline image={torstendnghImage}/>
          <ProjectTile title={"OracleOS"} tags={["React", "JavaScript", "Vite"]} description={"A mock futuristic OS with a few tiny apps"} image={oracleOsImage}/>
